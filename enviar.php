...
$headers .= "From: ".$web_actual." <info@dospz.es>\r\n";
$headers .= "Reply-To: info@dospz.es\r\n";
$headers .= "Return-path: info@dospz.es\r\n";
mail($contactmail,$asuntomail,$contenido_soli,$headers);//Envia el email
 //mail("info@dospz.es","prueba ","Comprobando emails en servidor axarnet");
